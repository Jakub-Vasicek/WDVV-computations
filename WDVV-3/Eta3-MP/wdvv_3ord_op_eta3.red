...
% File eta4: finding the operator for eta case 3) from MP paper
...
% Filling the matrix with values for eta case 3) in MP paper
gw11:=1;
gw12:=0;
gw13:=1;
gw22:=0;
