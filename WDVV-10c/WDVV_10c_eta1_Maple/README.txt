...
of RAM (CPU is not too important, computation is only memmory demanding) and
...
the same way and we should expect a one solution. Still it is prefered to use a
