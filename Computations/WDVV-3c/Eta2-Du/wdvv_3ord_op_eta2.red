...
% File eta2: finding the operator for eta case 2) from Dubrovin's paper
 ...
 for n:=1:ncomp do
  for k:=1:ncomp do
   ...
   <<
    ...
    equ2(eqtel2:=eqtel2+1):=df(c_lo(m,n,k),part(dep_var,l))+tempterm
   >>$
